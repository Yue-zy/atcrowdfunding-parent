	...
	<%@include file="/WEB-INF/jsp/common/js.jsp" %>
        ...
        <script type="text/javascript">
            			...
            			view: {
    						...
    						addHoverDom: function(treeId, treeNode){  //鼠标移动到节点上触发事件，增加按钮组 
    							...
    							if ( treeNode.level == 0 ) { //根节点
    								...
    								s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;"  onclick="update('+treeNode.id+')" title="修改权限信息">&nbsp;&nbsp;<i class="fa fa-fw fa-edit rbg "></i></a>';
    								s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;" onclick="remove('+JSON.stringify(treeNode).replace(/"/g,'&quot;')+')">&nbsp;&nbsp;<i class="fa fa-fw fa-times rbg "></i></a>';
            ...
            function remove(TreeNode){
				...
				layer.confirm('您确定要删除'+TreeNode.name+'吗?', {btn:['确定','取消']}, function(index){
            		
            		$.post("${PATH}/menu/delete",{id:TreeNode.id},function(result){
                		if(result=='ok'){        				
